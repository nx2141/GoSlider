...
// 初期設定
//
var autoLoadFlg = false;
var mySlider = document.querySelectorAll(".goslider li");
if (mySlider.length === 0) {
    console.log("GoSliderは要素を検知できませんでした");
}
else {
    mySlider.forEach(function (li, index) {
        if (index === 0) {
            //一番最初の要素にcurrentを付与
